...
export default function Categories() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-5 py-16">
      <Seo title="Categories · Micro Billboards" description="Browse South African advertising publishers by category — food, lifestyle, community, retail, property, and more — or by channel." />
      ...
      <p className="text-billboard-inkSoft max-w-xl mb-10">Every category is filled by real pages and groups already in the pilot — pick one to see who's on the board.</p>
