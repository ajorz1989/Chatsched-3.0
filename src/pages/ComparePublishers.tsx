...
export default function ComparePublishers() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-5 py-14">
      <Seo title="Compare Publishers · Micro Billboards" description="Compare up to 5 South African publishers side by side — audience, pricing, engagement and more." />
      ...
      {count === 0 ? (
        <div className="border-[3px] border-dashed border-billboard-ink rounded p-16 text-center">
          ...
          <h2 className="text-xl mb-2">Nothing to compare yet</h2>
          <p className="text-billboard-inkSoft mb-6 max-w-sm mx-auto">Browse publishers and click "Compare" on up to 5 to see them side by side.</p>
        ...
        <div className="space-y-3">
          {Array.from({ length: 4 }).map((_, i) => <div key={i} className="h-14 bg-billboard-paperDim rounded animate-pulse" />)}
        </div>
      ) : (
