...
export default function EarningsDashboard() {
  ...
  if (authLoading || loading) {
    return (
      <div className="max-w-4xl mx-auto px-5 py-14 space-y-4">
        {Array.from({ length: 4 }).map((_, i) => <div key={i} className="h-20 bg-billboard-paperDim rounded animate-pulse" />)}
      </div>
    );
  }
  ...
  return (
    <div className="max-w-5xl mx-auto px-5 py-14">
      <Seo title="Earnings Dashboard · Micro Billboards" description="Your publisher earnings, projections, and campaign performance." />
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          {recentEarnings.length === 0 ? (
            <div className="border-[3px] border-dashed border-billboard-ink rounded p-8 text-center text-billboard-inkSoft text-sm">
