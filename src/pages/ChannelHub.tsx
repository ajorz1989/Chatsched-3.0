  ...
  return (
    ...
    >
      ...
      <div className="absolute top-3 right-3 z-10">
        {enabled ? (
          ch.isLive ? (
            <span className="inline-flex items-center gap-1 bg-billboard-green text-white font-mono text-xs font-bold px-2 py-0.5 rounded-full uppercase tracking-wide">
              <span className="w-1.5 h-1.5 rounded-full bg-white inline-block" />
              Live
            </span>
          ) : (
            <span className="inline-flex items-center gap-1 bg-billboard-yellow text-billboard-ink font-mono text-xs font-bold px-2 py-0.5 rounded-full uppercase tracking-wide">
              Open
            </span>
          )
        ) : (
      ...
      <div className="p-5 flex-1 flex flex-col gap-4">
        ...
        {/* Pricing hint */}
        <div className="text-xs text-billboard-inkSoft font-mono border-t border-billboard-ink/10 pt-3">
          From R{ch.minBudgetZAR.toLocaleString()} · {ch.pricingModels[0].label}
        </div>
      </div>
...
export default function ChannelHub() {
  ...
  return (
    <>
      <Seo
        title="Advertising Channels — Micro Billboards"
        description="Every advertising channel available on Micro Billboards — social media, influencer campaigns, website advertising, podcast sponsorships, and radio."
      />
      ...
      <div className="max-w-6xl mx-auto px-5 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="text-billboard-inkSoft text-lg max-w-2xl">
            Every channel in the Micro Billboards marketplace. Social media, influencer campaigns,
            website advertising, podcast sponsorships, and radio are all live today — more channels open as the network grows.
          </p>
        </div>
        ...
        <div className="mt-16 border-[3px] border-billboard-ink rounded p-8 bg-billboard-paperDim text-center">
          ...
          <p className="text-billboard-inkSoft mb-6 max-w-lg mx-auto">
            Browse our live publisher directory and run your first social media campaign today.
