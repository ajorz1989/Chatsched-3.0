...
export default function ComingSoon({ title }: { title: string }) {
  return (
    <div className="max-w-2xl mx-auto px-5 py-24 text-center">
      ...
      <p className="text-billboard-inkSoft mb-7">This page is next on the list — we're building it out as the pilot grows. In the meantime, browse the directory or reach us on WhatsApp.</p>
