...
import { whatsappLink, CONTACT_EMAIL } from "../lib/constants";

const WHATSAPP_LINK = whatsappLink("Hi, I'd like to know more about Micro Billboards");
...
export default function Contact() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-5 py-16">
      <Seo title="Contact · Micro Billboards" description="Get in touch about Micro Billboards — reach us on WhatsApp or by email." />
      ...
      <p className="text-billboard-inkSoft max-w-xl mb-12">We're piloting in Cape Town and onboarding people personally — reach out and you'll hear back from us directly.</p>
      ...
      <div className="grid md:grid-cols-[0.85fr_1.15fr] gap-10">
        <div className="border-[3px] border-billboard-ink rounded p-6 bg-billboard-paperDim h-fit">
          ...
          <p className="text-xs text-billboard-inkSoft mt-5">Or email us directly at<br /><a href={`mailto:${CONTACT_EMAIL}`} className="font-semibold underline">{CONTACT_EMAIL}</a></p>
        </div>
