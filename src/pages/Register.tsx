...
export default function Register() {
  ...
  return (
    <div className="max-w-md mx-auto px-5 py-20">
      <Seo title="Create an Account · Micro Billboards" noindex />
      ...
      {role === "business" ? (
        ...
        <>
          ...
          <p className="text-billboard-inkSoft mb-8">Create your login here — you'll fill in your page details and apply on the next screen. Every application is reviewed by hand before it goes live.</p>
        </>
      )}
