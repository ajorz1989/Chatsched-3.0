...
const websiteModule: ChannelModule = {
  definition: {
    ...
    advertisingMethods: [
      { id: "header_banner", label: "Header banner placement", description: "Full-width banner at the top of every page." },
      { id: "sidebar_display", label: "Sidebar display ad", description: "Standard display unit alongside the site's content." },
      { id: "in_article", label: "In-article native placement", description: "An ad unit placed naturally within article content." },
      { id: "sponsored_post", label: "Sponsored blog post / advertorial", description: "A dedicated article written or approved by your brand." },
