...
const podcastModule: ChannelModule = {
  definition: {
    ...
    advertisingMethods: [
      { id: "pre_roll", label: "Pre-roll audio spot", description: "A short host-read ad before the episode content starts." },
      { id: "mid_roll", label: "Mid-roll audio spot", description: "Read partway through the episode, where listener attention peaks." },
      { id: "post_roll", label: "Post-roll audio spot", description: "Read after the episode ends — lower cost, still-engaged listeners." },
      ...
      { id: "series_sponsorship", label: "Series / season sponsorship", description: "Recurring mentions across a full run of episodes." },
    ],
    eligibility: {
