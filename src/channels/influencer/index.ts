...
const influencerModule: ChannelModule = {
  definition: {
    ...
    advertisingMethods: [
      { id: "feed_post", label: "Dedicated feed post", description: "A standalone post on the creator's main feed." },
      { id: "story_series", label: "Story series", description: "A run of Instagram/Facebook Stories built around your brand." },
      { id: "reel_short_video", label: "Reel / short-form video", description: "A single short-form video placement (Reels, TikTok-style)." },
      { id: "long_form_review", label: "Long-form video review or unboxing", description: "An in-depth video review, demo, or unboxing." },
      { id: "brand_ambassador", label: "Brand ambassadorship", description: "An ongoing monthly retainer with regular content." },
      { id: "affiliate_link", label: "Affiliate / performance link", description: "Content built around a trackable affiliate link or code." },
    ],
    eligibility: {
