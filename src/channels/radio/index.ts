...
const radioModule: ChannelModule = {
  definition: {
    ...
    advertisingMethods: [
      { id: "spot_30s", label: "30-second spot", description: "Standard rotation slot in regular programming." },
      { id: "spot_60s", label: "60-second spot", description: "Extended slot for a fuller message." },
      { id: "live_read", label: "Live read by on-air host", description: "The host reads your ad live, in their own words and voice." },
      { id: "show_sponsorship", label: "Show / segment sponsorship", description: "Your brand named as the sponsor of a regular show or segment." },
      { id: "outside_broadcast", label: "Outside broadcast / event mention", description: "A mention or activation during a station's live outside broadcast." },
    ],
    eligibility: {
