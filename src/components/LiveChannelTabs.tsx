...
// The 4 channels launched alongside social media — hero copy written fresh
// for this placement (each channel's own tagline is reused instead on its
// Channel Hub card and dedicated page, so the two never repeat). Shared
// between Home and Categories so both show the exact same hero messages.
