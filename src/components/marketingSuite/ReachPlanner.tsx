      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          {result.matches.length === 0 ? (
            <p className="text-sm text-billboard-inkSoft border-[3px] border-dashed border-billboard-ink rounded p-6 text-center">
              No strong matches — <Link to="/browse" className="underline font-semibold">browse everyone</Link>.
            </p>
          ) : (
