    ...
    <section className="border-[3px] border-billboard-ink rounded p-5 mb-10">
      <div className="flex flex-wrap items-start justify-between gap-3 mb-4">
        <div>
          ...
          <h2 className="font-display text-xl md:text-2xl">Plan campaigns with data — smarter tools coming</h2>
          <p className="text-sm text-billboard-inkSoft mt-1 max-w-xl">
            Rule-based matching and estimates today. Caption generation stays disabled until a content
            provider is connected — no fabricated recommendations.
          </p>
        </div>
      </div>
