-- Micro Billboards — Phase 17 schema additions
...
create table public.channel_requests (
  ...
  -- 7-day creator approval window, from submission.
  approval_due_at timestamptz generated always as (created_at + interval '7 days') stored,
  ...
  payment_due_at timestamptz generated always as (responded_at + interval '7 days') stored,
  payment_submitted_at timestamptz,
  paid_at timestamptz,
  live_at timestamptz,
  -- 48-hour creator payout window, from going live.
  payout_due_at timestamptz generated always as (live_at + interval '48 hours') stored,
